...
class Config(BaseModel):
    """
    This class defines the configuration settings required for the project.
    It uses environment variables to populate its attributes.
    """
    ...
    summary_prompt: str = ("You are a software engineer and Python expert. Summarize the following file, "
                           "including its functions, classes, and overall content and how it works together.")
                           # Put the summary on top of each "
